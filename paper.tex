...
\textcolor{blue}{The application of the \textit{k}-induction method is gaining popularity in the software verification community. Bradley {\it et al.} introduced  ``property-based reachability'' (or IC$3$) procedure for the safety verification of systems~\cite{Bradley12,Bradley13}; the authors have shown that IC$3$ can scale on certain benchmarks, where \textit{k}-induction fails to succeed.}
