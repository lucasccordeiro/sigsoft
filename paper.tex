...
Regarding behavior correctness, many other applications can be tackled, such as the ones related to automatic classification. Amoedo {\it et. al} proposed a modulation classification methodology, which the goal of spectrum sensing for opportunistic transmissions. Given that 
%--------------------------------------
\section{Conclusions}
\label{conclusions}
%--------------------------------------
