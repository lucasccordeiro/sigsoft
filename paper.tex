...
\textcolor{blue}{Due to the advent of sophisticated SMT solvers built over efficient SAT solvers, an increasingly number of software verifiers and synthesizers are being developed in the literature, in order to improve  productivity and produce efficient implementations for a ECPS design specification. Here, we describe recent advances in symbolic model checking of software, including BMC, \textit{k}-induction, and Craig interpolation techniques. This section also overviews software synthesis techniques that also use logic to describe states and transformations between system states.}
