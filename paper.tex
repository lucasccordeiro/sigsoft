...
Rungger and Tabuada~\cite{Rungger16} and Tabuada et al.~\cite{Tabuada14} proposed a general and wide model for ECPS based on hybrid automata, providing the concept of robustness and important tools for robust stability analysis for ECPS.
